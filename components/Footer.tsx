      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-br from-purple-600 via-blue-500 to-teal-400 text-white font-bold text-sm">
              FQ
            </div>
            <span className="text-white font-medium">Felix Quan</span>
          </div>
          ...
          <div className="flex gap-3">
            {socials.map((s) => (
              <a
                ...
                aria-label={s.name}
                className="w-9 h-9 flex items-center justify-center rounded-full border border-gray-700 hover:text-white hover:border-white transition-colors"
              >
                {s.icon}
              </a>
            ))}
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-center text-xs text-gray-600">
          © {year} Felix Quan. Built with Next.js.
        </div>
      </div>
    </footer>
  );
